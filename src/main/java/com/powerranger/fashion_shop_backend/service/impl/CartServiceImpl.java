...
import com.powerranger.fashion_shop_backend.mapper.CartMapper;
...
public class CartServiceImpl implements CartService {
    ...
    private Cart getOrCreateCart(String email, String sessionToken) {
        if (email != null) {
            ...
            String token = (sessionToken != null && !sessionToken.isBlank()) ? sessionToken : java.util.UUID.randomUUID().toString();
